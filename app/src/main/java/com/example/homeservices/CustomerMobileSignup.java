...
public class CustomerMobileSignup extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_mobile_signup);
    ...
    private void verifyPhoneNumberWithCode(String verificationId, String code) {
       ...
       /* String phone = mPhoneNumberField.getText().toString();
        Intent i;
        i=new Intent(this,CustomerSignupActivity.class);
