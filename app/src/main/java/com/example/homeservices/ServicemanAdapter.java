...
public class ServicemanAdapter extends BaseAdapter {
    ...
    public ServicemanAdapter(Context c, List<String> cname, List<String> cmobile, List<String> caddress,List<String> model,List<String> issue, List<String> visitcharge, List<String> pr_mobile, List<String> pr_name)
    {
        this.c = c;
        this.cname=cname;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View v=li.inflate(R.layout.servicemanadapter, null);
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(v.getContext(),CustomerDescription2.class);
