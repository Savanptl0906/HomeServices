...
public class ProviderMapLocation extends FragmentActivity implements OnMapReadyCallback, NetworkInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_provider_map_location);
    ...
    public void init() {
        ...
        frag = (SupportMapFragment) fm.findFragmentById(R.id.fr1);
...
//        getDeviceLocation();
        ...
        t.addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                if (task.isSuccessful() == true) {
                    ...
                    Toast.makeText(ProviderMapLocation.this, "Location not found", Toast.LENGTH_SHORT).show();
                }
    ...
    public void confirmReq(View v){
        ...
        String mobile=spf.getString("sharedmobile","sharedmobile");
        try{
    ...
    public void networkResult(String msg) {
        ...
        if(msg.equals("insertion failed"))
        {
            ...
            Toast.makeText(ProviderMapLocation.this,"Signup Done Successfully",Toast.LENGTH_LONG).show();
    ...
    public void go(View view)
    {
        ...
        try {
            List<Address> list = coder.getFromLocationName(a,1);
            Address ad = list.get(0);
             d1 = ad.getLatitude();
             d2 = ad.getLongitude();
            b.setEnabled(true);
            moveCamera(new LatLng(d1,d2),15,a);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
