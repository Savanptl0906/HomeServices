...
public class ProviderMobileSignup extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_provider_mobile_signup);
    ...
    private void verifyPhoneNumberWithCode(String verificationId, String code) {
        ...
        Intent i;
        i=new Intent(this,ProviderRegistration.class);
